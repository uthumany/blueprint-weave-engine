...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NOTEPADIFY" },
      { name: "description", content: "NOTEPADIFY lets you point at any website or paste a screenshot, then instantly extracts its complete visual DNA — colors, typography, spacing, motion, mood." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "NOTEPADIFY" },
      { property: "og:description", content: "NOTEPADIFY lets you point at any website or paste a screenshot, then instantly extracts its complete visual DNA — colors, typography, spacing, motion, mood." },
